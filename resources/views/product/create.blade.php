        ...
        <form action="{{ route('product.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="card-body">
                ...
                <div class="form-group col-md-6">
                    ...
                    <div class="input-group">
                        <div class="custom-file">
                            <input type="file" value="{{ old('preview_image') }}" name="preview_image"
                                class="custom-file-input" id="previewImage" placeholder="{{ old('preview_image') }}">
                            <label class="custom-file-label" for="previewImage">{{ old('preview_image') }}</label>
                        </div>
                ...
                <div class="form-group col-md-6">
                    ...
                    <div class="input-group">
                        <div class="custom-file">
                            <input type="file" value="{{ old('detail_image') }}" name="detail_image"
                                class="custom-file-input" id="detailImage" placeholder="{{ old('detail_image') }}">
                            <label class="custom-file-label" for="detailImage">{{ old('detail_image') }}</label>
                        </div>
                        <div class="input-group-append">
                            <span class="input-group-text">Upload</span>
                        </div>
                ...
                <div class="form-group col-md-6">
                    ...
                    @foreach (range(0, 2) as $i)
                        <div class="input-group">
                            <div class="custom-file">
                                <input type="file" value="{{ old('product_images[' . $i . ']') }}"
                                    name="product_images[]" class="custom-file-input" id="productImage_{{ $i }}"
                                    placeholder="{{ old('product_images[' . $i . ']') }}">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input type="text" value="{{ old('price') }}" name="price" class="form-control"
                            id="productPrice" placeholder="{{ old('price') }}">
                        @error('price')
                            <div class="text-danger">{{ $message }}</div>
                        @enderror
                    </div>
                    <div class="form-group col-md-6">
                        ...
                        <input type="text" value="{{ old('count') }}" name="count" class="form-control"
                            id="productCount" placeholder="{{ old('count') }}">
                        @error('count')
                            <div class="text-danger">{{ $message }}</div>
                        @enderror
                    </div>
                        ...
                        <select class="form-control" name="colors[]" multiple>
                            @foreach ($colors as $color)
                                <option value="{{ $color->id }}"
                                    style="border-left: solid 21px #{{ $color->title }};">
                                    #{{ $color->title }}
                                </option>
                            @endforeach
                        </select>
